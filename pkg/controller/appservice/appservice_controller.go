...
import (
	...
	futureteav1 "github.com/futuretea/appservice/pkg/apis/futuretea/v1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &futureteav1.AppService{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &futureteav1.AppService{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileAppService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &futureteav1.AppService{}
...
func newPodForCR(cr *futureteav1.AppService) *corev1.Pod {
